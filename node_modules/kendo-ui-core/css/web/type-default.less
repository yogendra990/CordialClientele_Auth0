...
@disabled-text-color: contrast(@base, lighten(@base, 25%), darken(@base, 29%), 0.5);
...
@draghandle-border-color: darken(@success, 20%);
@draghandle-background-color: lighten(@base, 15%);
@draghandle-shadow: none;
@draghandle-hover-border-color: darken(@success, 23%);
...
@upload-progress-text-color: contrast(@upload-progress-background-color, lighten(@info, 70%), darken(@info, 50%), 0.5);
@upload-success-background-color: @success;
@upload-success-text-color: contrast(@upload-success-background-color, lighten(@success, 70%), darken(@success, 50%), 0.5);
@upload-error-background-color: @error;
@upload-error-text-color: contrast(@upload-error-background-color, lighten(@error, 70%), darken(@error, 50%), 0.5);
