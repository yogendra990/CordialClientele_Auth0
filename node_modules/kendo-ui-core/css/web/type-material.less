...
@upload-progress-text-color: contrast(@upload-progress-background-color, lighten(@info, 70%), darken(@info, 40%), 0.5);
@upload-success-background-color: @success;
@upload-success-text-color: contrast(@upload-success-background-color, lighten(@success, 70%), darken(@success, 40%), 0.5);
@upload-error-background-color: @error;
@upload-error-text-color: contrast(@upload-error-background-color, lighten(@error, 70%), darken(@error, 40%), 0.5);
